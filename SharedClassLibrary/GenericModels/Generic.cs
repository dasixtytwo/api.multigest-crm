...
public static class Generics
{
  public static ClaimsPrincipal SetClaimPrincipal(UserSession model)
  {
    return new ClaimsPrincipal(new ClaimsIdentity(
        new List<Claim>
        {
                  ...
                  new(ClaimConstants.TenantId, model.TenantId!),
        }, "JwtAuth"));
  }
  ...
  public static UserSession GetClaimsFromToken(string jwtToken)
  {
    ...
    string TenantId = claims.First(c => c.Type == ClaimConstants.TenantId).Value!;

    return new UserSession(Id, Name, Email, Role, TenantId);
  }
